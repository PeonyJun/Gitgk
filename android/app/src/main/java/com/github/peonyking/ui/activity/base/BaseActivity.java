...
package com.github.peonyking.ui.activity.base;
...
import com.github.peonyking.http.Downloader;
...
import com.github.peonyking.ui.widget.DoubleClickHandler;
import com.github.peonyking.util.AppUtils;
import com.github.peonyking.util.PrefUtils;
import com.github.peonyking.util.ThemeHelper;
import com.github.peonyking.util.WindowUtil;
...
BaseActivity<P extends IBaseContract.Presenter>
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == Downloader.REQUEST_STORAGE_PERMISSION) {
            boolean granted = grantResults.length > 0
                    && grantResults[0] == PackageManager.PERMISSION_GRANTED;
            Downloader.onRequestPermissionsResult(requestCode, granted);
        }
    }
